              ...
              <form onSubmit={handleSendOtp} className="flex flex-1 flex-col gap-4">
                ...
                <div className="mt-4 flex flex-col gap-4">
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full rounded-2xl border-2 border-primary bg-transparent py-4 text-base font-bold text-primary transition-all active:scale-[0.98] disabled:opacity-50"
                  >
